export const localeContent = {
  "en-US": {
    ...
    projectLead: "A bookmarklet for downloading images from Instagram.",
  ...
  "de-DE": {
    ...
    projectLead: "Ein Bookmarklet, um Bilder auf Instagram herunterzuladen",
  ...
  "pt-BR": {
    ...
    projectLead: "Um bookmarklet para download de fotos do Instagram",
  ...
  "es-AR": {
    ...
    projectLead: "Un bookmarklet para descargar imágenes de Instagram.",
