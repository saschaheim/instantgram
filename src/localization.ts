export default {
    "langs": {
        "en-US": {
            ...
            "index#program#modal_settings@settings_attention": "Attention: You have to open [instantgram] again for your changes to be active!",
            "index#program#modal_settings@settings_checkbox_1": "Enable monetized posts<br>(ad blockers must be disabled)",
            "index#program#modal_settings@settings_checkbox_2": "Stories pause when opening [instantgram]",
        ...
        "es-AR": {
            ...
            "index#program#modal_settings@settings_attention": "Atención: ¡Tienes que abrir [instantgram] nuevamente para que los cambios estén activos!",
            ...
            "index#program#modal_settings@settings_checkbox_2": "Historias en pausa al abrir [instantgram]",
        ...
        "pt-BR": {
            ...
            "index#program#modal_settings@settings_attention": "Atenção: Você precisa abrir o [instantgram] novamente para que suas alterações sejam ativadas!",
            ...
            "index#program#modal_settings@settings_checkbox_2": "As histórias fazem uma pausa ao abrir [instantgram]",
