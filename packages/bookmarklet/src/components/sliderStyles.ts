...
const sliderRules = [
  ...
  `.slider-controls button{cursor:pointer;width:30px;height:30px;padding:0;margin:0;border-radius:9px;border:1px solid #d9d2cb;display:inline-flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#58636d;background:#fff;box-shadow:0 1px 2px rgba(16,24,32,.06);transition:transform .18s ease,color .18s ease,border-color .18s ease,background .18s ease}`,
  ...
  `.slider-controls button.active.progressing{border:2px solid transparent;background:linear-gradient(120deg,#101820,#367da3) padding-box,conic-gradient(#65b8dc calc(var(--progress,0)*1%),#c8d6dd 0) border-box!important}`,
];
