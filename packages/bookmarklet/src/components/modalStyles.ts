...
const modalCssRules = [
  ...
  `.igb{display:inline-flex;align-items:center;gap:8px;font-weight:700;letter-spacing:-.02em}`,
  `.igb b{display:grid;width:27px;height:27px;place-items:center;border:1px solid rgba(255,255,255,.35);border-radius:8px 8px 8px 3px;color:#fff;background:#101820;font-size:16px;line-height:1}`,
  ...
  `.ium .${modalContent}:before{content:"";position:absolute;inset:0 0 auto 0;height:118px;background:linear-gradient(120deg,#101820 0%,#193342 58%,#367da3 100%);pointer-events:none}`,
