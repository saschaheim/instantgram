...
const modalCssRules = [
  ...
  `.${settings},.ima{cursor:pointer;box-sizing:border-box;padding:0!important;color:rgba(255,255,255,.7);background-color:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.2);border-radius:.3rem;transition:color .2s,background-color .2s,border-color .2s,transform .24s ease;width:40px;height:40px;font-size:20px;font-weight:700;line-height:1}`,
  ...
  `.ib i{position:relative;top:-1px}`,
  ...
  `.ium .${modalFooter}{background:#fff!important;border-top:1px solid #eef3f7!important;min-height:72px!important;padding:12px 20px 20px!important}`,
