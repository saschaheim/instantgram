...
const sliderRules = [
  ...
  ".slider-controls button.active{color:#fff;border:2px solid transparent;background:"+G+" padding-box,conic-gradient(#65b8dc calc(var(--progress,0)*1%),#c8d6dd 0) border-box"+I+";box-shadow:0 1px 2px rgba(55,109,144,.35)}",
