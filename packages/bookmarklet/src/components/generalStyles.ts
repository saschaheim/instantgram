...
const generalRules = [
  ...
  `.sy{margin:0}`,
  `.st{display:flex;gap:4px;margin:14px;padding:4px;background:#edf3f7;border-radius:12px}`,
  `.tb{flex:1;display:block;padding:.55rem 1rem;cursor:pointer;color:#526574;background:transparent;border:0;border-radius:9px;font-weight:700;transition:color .2s,background-color .2s,box-shadow .2s}`,
  `.st .tb.active{color:#163042;background:#fff;box-shadow:0 2px 8px rgba(24,54,74,.12)}`,
  `.tc{padding:0 14px 14px}`,
  `.tp{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}`,
  `.si{display:block;min-width:0;padding:13px 14px;background:#fff;border:1px solid #e5edf2;border-radius:14px;box-shadow:0 4px 14px rgba(24,54,74,.06)}`,
  `.si:not(.wide){cursor:pointer;transition:border-color .2s,box-shadow .2s,transform .2s}`,
  `.si:not(.wide):hover{border-color:#bfd3df;box-shadow:0 7px 18px rgba(24,54,74,.11);transform:translateY(-1px)}`,
  ...
  `.sw{position:relative;padding:11px 16px;font-size:13px;line-height:1.45;color:#526574;background:#f6f9fb;border:1px solid #e5edf2;border-radius:12px}`,
