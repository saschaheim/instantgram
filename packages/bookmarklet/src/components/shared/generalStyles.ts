...
const slideOnRules = [
  ...
  ".slideon-slider{position:absolute;cursor:pointer;inset:0;background-color:#ccc;"+(FIREFOX_LITE?"":"border-radius:34px;transition:.4s")+"}",
  '.slideon-slider:before{position:absolute;content:"";height:22px;width:22px;left:1px;bottom:1px;background-color:#fff'+(FIREFOX_LITE?"":';border-radius:50%;transition:.4s;box-shadow:0 0 3px 0 rgba(0,0,0,.45)')+"}",
...
const generalRules = [
  ...
  ...(!FIREFOX_LITE ? ["@keyframes horizontal-shaking{0%,100%{transform:translateX(0)}25%,75%{transform:translateX(5px)}50%{transform:translateX(-5px)}}"] : []),
  ...
  ".sy{margin:0}",
  ".st{display:flex;gap:4px;margin:14px;padding:4px"+(FIREFOX_LITE?"":";background:#e8e2dc;border-radius:12px")+"}",
  ".tb{flex:1;display:block;padding:.55rem 1rem;cursor:pointer;border:0"+(FIREFOX_LITE?"":";color:#58636d;background:transparent;font-weight:700;border-radius:9px;transition:color .2s,background-color .2s,box-shadow .2s")+"}",
  ...
  ".si{display:block;min-width:0;padding:13px 14px"+(FIREFOX_LITE?"":";background:#fff;border:1px solid #ded8d2;border-radius:14px;box-shadow:0 4px 14px rgba(16,24,32,.06)")+"}",
  ...(!FIREFOX_LITE ? [
  ...
  ...(!FIREFOX_LITE ? [".si strong{font-size:15px;line-height:1.28}"] : []),
  ...
  ".sw{position:relative;padding:11px 16px;font-size:13px;line-height:1.45"+(FIREFOX_LITE?"":";color:#58636d;background:#efded3;border:1px solid #e2cec1;border-radius:12px")+"}",
  ...(!FIREFOX_LITE ? [".sw .sx{color:#367da3;font-weight:700}"] : []),
